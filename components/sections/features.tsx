    ...
    return (
        <div className="w-full mt-16 px-5 md:px-10 xl:px-28">
            ...
            <div className="w-full flex flex-col gap-5 mt-5 lg:flex-row lg:gap-10 lg:items-start lg:justify-between">
                <div className="w-full flex flex-col gap-2 lg:w-[55%]">
            ...
            <div className="w-full mt-14 xl:mt-20 grid grid-cols-1 md:grid-cols-2 gap-6">
                <FeaturesCard imageSrc={Feature1} title="Total operational visibility" description="Track your money with real-time transaction monitoring. Resolve network issues before they affect customers." />
