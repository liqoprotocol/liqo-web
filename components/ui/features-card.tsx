...
const FeaturesCard = ({ imageSrc, title, description, className }: FeaturesCardProps) => {
    return (
        ...
        ${className}`}
        >
            <div className="relative overflow-hidden lg:h-95">
                <Image
                ...
                <div
                    className="absolute inset-x-0 bottom-0 h-20 lg:h-28 pointer-events-none
            bg-linear-to-t from-[#1A1A1A] via-[#1A1A1A]/60 to-transparent"
                />
            </div>

            <div className="p-4 mt-auto gap-3 flex flex-col pb-8">
